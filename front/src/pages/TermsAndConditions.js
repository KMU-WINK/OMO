...
function TermsAndConditions(props) {
    ...
    return (
        <div style={allContents}>
            <Header state={"Back"} title={"서비스 이용약관"}/>
            <div style={subContent}>
                <p style={whatPage}>제1장 총칙</p>
                <div style={whatPageTXT}>
                ...
                <p style={whatPage}>제3장 콘텐츠이용계약</p>
                <div style={whatPageTXT}>
                ...
                <p style={whatPage}>제4장 콘텐츠이용계약의 청약철회, 계약해제·해지 및 이용제한</p>
                <div style={whatPageTXT}>
                    ...
                    ② "회사"가 제1항에 따라 환급할 경우에 "이용자"가 서비스이용으로부터 얻은 이익에 해당하는 금액을 공제하고 환급할 수 있습니다.<br/><br/>
                    ...
                    ⑤ "회사"는 "이용자"에게 청약철회를 이유로 위약금 또는 손해배상을 청구하지 않습니다. 그러나 "이용자"의 계약해제·해지는 손해배상의 청구에 영향을 미치지<br/>
                ...
                <p style={whatPage}>제5장 과오금, 피해보상 등</p>
                <div style={whatPageTXT}>
                    제30조(과오금) <br/>
